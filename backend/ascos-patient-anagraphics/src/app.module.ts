...
import { HealthController, PatientsController } from './controllers'
...
@Module({
  imports: modules,
  controllers: [PatientsController, HealthController],
...
export class AppModule implements NestModule {
  configure (consumer: MiddlewareConsumer) {
    consumer.apply(HttpMiddleware).forRoutes(PatientsController)
  }
}
