...
const contractName = 'create-none-insurance-case-test-day-contract'
const doctorName = 'create-none-insurance-case-test-doctor-name'
const doctorSurname = 'create-none-insurance-case-test-doctor-surname'
const roleName = 'create-none-insurance-case-test-role-admin'
const opStandardName = 'create-none-insurance-case-test-opStandard'
const roomName = 'create-none-insurance-case-test-room'
...
prepareTest({
  ...
  users: [
    {
      ...
      email: 'create-none-insurance-case-test@tester.com',
      phoneNumber: '123',
  ...
  'Create new booking request with insurance none',
  async ({
    page,
    baseURL,
    available_insurances,
